...
Public Class LapBeliCash
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UKK___Sistem_Pembelian_Mobil.LapBeliCash.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapBeliCash
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapBeliCash = New LapBeliCash()
        rpt.Site = Me.Site
        Return rpt
    End Function
