...
Public Class LapPaketKredit
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UKK___Sistem_Pembelian_Mobil.LapPaketKredit.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapPaketKredit
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPaketKredit = New LapPaketKredit()
        rpt.Site = Me.Site
        Return rpt
    End Function
