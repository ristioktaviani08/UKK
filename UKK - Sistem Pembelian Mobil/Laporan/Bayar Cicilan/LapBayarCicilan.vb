...
Public Class LapBayarCicilan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UKK___Sistem_Pembelian_Mobil.LapBayarCicilan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapBayarCicilan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapBayarCicilan = New LapBayarCicilan()
        rpt.Site = Me.Site
        Return rpt
    End Function
