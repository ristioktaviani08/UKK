...
Public Class LapPengguna
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "UKK___Sistem_Pembelian_Mobil.LapPengguna.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLapPengguna
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As LapPengguna = New LapPengguna()
        rpt.Site = Me.Site
        Return rpt
    End Function
